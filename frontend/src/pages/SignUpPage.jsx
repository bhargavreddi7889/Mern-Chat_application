          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                <User className="size-5 text-base-content/40 absolute inset-y-0 left-0 pl-3" />
                <input type="text" className="input input-bordered w-full pl-10" placeholder="Enter Full name" 
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <User className="size-5 text-base-content/40 absolute inset-y-0 left-0 pl-3" />
                <input type="text" className="input input-bordered w-full pl-10" placeholder="Enter your username"
