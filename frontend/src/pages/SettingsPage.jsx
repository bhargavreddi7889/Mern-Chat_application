      ...
      <div className="container mx-auto p-6 max-w-5xl">
        <div className="bg-base-100 rounded-xl shadow-xl p-6 border border-base-300">
          <div className="text-center mb-6">
            ...
            <p className="text-base-content/70 mt-2">Customize your chat experience</p>
          </div>
                ...
                {THEMES.map((t) => (
                  <button
                    ...
                    className={`
                      ...
                      ${theme === t ? "bg-base-200 border border-base-300" : "hover:bg-base-200/50"}
                    `}
                    onClick={() => setTheme(t)}
                  >
                      ...
                      <div className="px-4 py-3 border-b border-base-300 bg-base-200/50">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-base-content/70">@username • Online</p>
                          </div>
                        </div>
                      </div>
